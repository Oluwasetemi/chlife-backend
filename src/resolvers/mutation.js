        ...
        const options = {
          ...
          formData: {
            json: `{"appraise_risks.client_id":"fitnessfair","appraise_risks.user_id":"${
              ...
              'not answered'}", "hra.q.a.bathing": "${currentResponse.bathing ||
              'not answered'}", "hra.q.a.dressing": "${currentResponse.dressing ||
              'not answered'}", "hra.q.a.eating": "${currentResponse.eating ||
              'not answered'}", "hra.q.a.out_of_bed": "${currentResponse.out_of_bed ||
              'not answered'}", "hra.q.a.walking": "${currentResponse.walking ||
              'not answered'}", "hra.q.a.getting_outside": "${currentResponse.getting_outside ||
              'not answered'}", "hra.q.a.using_toilet": "${currentResponse.using_toilet ||
              'not answered'}", "hra.q.a.meals": "${currentResponse.meals ||
              'not answered'}", "hra.q.a.shopping": "${currentResponse.shopping ||
              'not answered'}", "hra.q.a.managing_money": "${currentResponse.managing_money ||
              'not answered'}", "hra.q.a.telephone": "${currentResponse.telephone ||
              'not answered'}", "hra.q.weight.a.heavy_housework": "${currentResponse.heavy_housework ||
              'not answered'}", "hra.q.weight.a.light_housework": "${currentResponse.light_housework ||
              'not answered'}", "hra.q.weight.a.out_of_house": "${currentResponse.out_of_house ||
              'not answered'}","hra.q.weight.a.limit_crime": "${currentResponse.limit_crime ||
              'not answered'}", "hra.q.a.limit_crime": "${currentResponse.limit_crime ||
              'not answered'}",
            "hra.q.a.age_at_menarche": "${currentResponse.age_at_menarche ||
              'not answered'}", "hra.q.a.age_of_bearing_first_child": "${currentResponse.age_of_bearing_first_child ||
              'not answered'}", "hra.q.a.family_breast_cancer_history": "${currentResponse.family_breast_cancer_history ||
              'not answered'}", "hra.q.a.prostate_cancer_screening": "${currentResponse.prostate_cancer_screening ||
              'not answered'}", "hra.q.a.relatives_cancer": "${currentResponse.relatives_cancer ||
              'not answered'}", "hra.q.a.unprotected_sex": "${currentResponse.unprotected_sex ||
              'not answered'}", "hra.q.a.street_drugs": "${currentResponse.street_drugs ||
              'not answered'}"}`,
          },
          /* eslint-enable */
        };
