  ...
  async submitHRAResponse(_, { input }, { req }) {
    try {
      ...
      if (input.stage === 'SUBMIT') {
        ...
        const hraData = await hra.findById(req.user.hra[0]._id.toString());
